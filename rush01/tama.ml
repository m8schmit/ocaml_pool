...
let draw_fill truc x y = match truc with
	...
	| n when n < 66 ->Graphics.set_color Graphics.yellow;
					...
					Graphics.set_color Graphics.white;
					Graphics.fill_rect (x + n / 2) y (100 - n / 2) 10
	| n when n < 98 ->Graphics.set_color Graphics.green;
			Graphics.fill_rect x y (n / 2) 10;
			Graphics.set_color Graphics.white;
			Graphics.fill_rect (x + n / 2) y (100 - n / 2) 10
	| _ -> Graphics.set_color Graphics.green;
			Graphics.fill_rect x y 50 10
...
let draw_endgame str =
	...
	Graphics.set_color Graphics.white;
	Graphics.fill_rect 0 250 300 50;
	Graphics.fill_rect 0 0 300 50;
...
let rec loop (t:Tama.gochi) (time:int) =
	...
	if bla.Graphics.button = false && (int_of_float (Unix.time ()) - time >= 1) && Tama.is_dead t = false then 
		...
		|(x, y) when x >= 55 && x <= 95 && y >= 10 && y <= 40 && Tama.is_dead t = false -> Graphics.sound 1000 1000;draw_tama "eat1_pika.png"; draw_tama "eat1_pika.png";draw_tama "eat1_pika.png";draw_tama "eat1_pika.png";draw_tama "eat1_pika.png"; draw_tama "eat1_pika.png"; draw_tama "eat1_pika.png";draw_tama "eat1_pika.png";draw_tama "eat1_pika.png";draw_tama "eat1_pika.png"; loop (Tama.eat t) (int_of_float (Unix.time ()))
		|(x, y) when x >= 105 && x <= 145 && y >= 10 && y <= 40 && Tama.is_dead t = false ->Graphics.sound 1000 1000;draw_tama "bath1_pika.png"; draw_tama "bath1_pika.png"; draw_tama "bath1_pika.png"; draw_tama "bath1_pika.png"; draw_tama "bath1_pika.png"; draw_tama "bath1_pika.png"; draw_tama "bath1_pika.png"; draw_tama "bath1_pika.png"; draw_tama "bath1_pika.png"; draw_tama "bath1_pika.png"; loop (Tama.bath t) (int_of_float (Unix.time ()))
		|(x, y) when x >= 155 && x <= 195 && y >= 10 && y <= 40 && Tama.is_dead t = false ->Graphics.sound 1000 1000;draw_tama "thunder2_pika.png"; draw_tama "thunder2_pika.png"; draw_tama "thunder2_pika.png"; draw_tama "thunder2_pika.png"; draw_tama "thunder2_pika.png"; draw_tama "thunder2_pika.png"; draw_tama "thunder2_pika.png"; draw_tama "thunder2_pika.png"; draw_tama "thunder2_pika.png"; draw_tama "thunder2_pika.png"; loop (Tama.thunder t) (int_of_float (Unix.time ()))
		|(x, y) when x >= 205 && x <= 245 && y >= 10 && y <= 40 && Tama.is_dead t = false ->Graphics.sound 1000 1000;draw_tama "kill1_pika.png"; draw_tama "kill1_pika.png"; draw_tama "kill1_pika.png"; draw_tama "kill1_pika.png"; draw_tama "kill1_pika.png";draw_tama "kill1_pika.png"; draw_tama "kill1_pika.png"; draw_tama "kill1_pika.png"; draw_tama "kill1_pika.png"; draw_tama "kill1_pika.png";loop (Tama.kill t) (int_of_float (Unix.time ()))
